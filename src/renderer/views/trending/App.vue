  ...
  <div class="trending">
    <div class="filter">
      <div class="filter-left">
        <el-button-group>
          <el-button :type="type === 'repositories' ? 'primary' : 'default'" size="mini" @click="changeTypeEvent('repositories')">Repositories</el-button>
          <el-button :type="type === 'developers' ? 'primary' : 'default'" size="mini" @click="changeTypeEvent('developers')">Developers</el-button>
        </el-button-group>
      </div>
      <div class="filter-right">
        <div class="fr-item" v-show="type === 'repositories'">
          <span>Spoken Language: </span>
          <el-select v-model="spokenLanguage.value" size="mini" @change="spokenLanguageChangeEvent">
            <el-option
        ...
        <div class="fr-item">
          <span>Language: </span>
          <el-select v-model="language.value" size="mini">
            <el-option
        ...
        <div class="fr-item">
          ...
          <el-select v-model="data.value" size="mini">
            <el-option
    ...
    <div class="content scroll">
      <div class="content-wrapper">
        <div class="repo-item" v-show="type === 'repositories'">
...
import { spokenLanguageTool } from '../../utils/tools'
import { trendingRepoType } from '../../../type/index'

const type = ref('repositories')
...
// 切换类型
function changeTypeEvent (t: string) {
  type.value = t
}

// 切换说话语言
async function spokenLanguageChangeEvent (code: string) {
  content.value = await spokenLanguageTool(code)
}

onMounted(() => {
  spokenLanguageChangeEvent('zh')
})
</script>
