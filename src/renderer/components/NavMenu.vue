<template>
  <div class="navMenu">
    ...
    <div class="menu-nav">
      ...
      <span :class="['button', 'nt-btn', active === 'notification' ? 'active' : '']" @click="routerEvent('notification')" title="Gist">
    ...
    <div class="setting">
      <span :class="['button', 'nt-btn', active === 'settings' ? 'active' : '']" @click="routerEvent('settings')" title="Settings">
