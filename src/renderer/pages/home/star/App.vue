<template>
  <div class="star">
    <div class="tags scroll" v-loading="refreshLoading">
      <div class="cat">
        <div class="cat-header">
          <span class="icon-btn" @click="refreshList" :title="t('component.refresh')">
    ...
    <div class="list"  v-loading="refreshLoading">
      <div class="list-search">
        <el-input size="mini" v-model="searchText" @input="searchEvent" clearable></el-input>
      </div>
...
async function searchEvent () {
  if (searchText.value !== '') {
    ...
    all.value = await star.search(reg)
  } else {
    all.value = await star.all()
  }
}
